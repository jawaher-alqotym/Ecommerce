...
const Color mainColor = Color(0xffb100be);
const Color darkGreyClr = Color(0xFF410044);
const Color pinkClr = Color(0xffea3dfc);
...
const Color accountSettings = Color(0xffa665bc);
